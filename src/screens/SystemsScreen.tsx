// ========================================
// SYSTEMS SCREEN - V2
// Manage systems (groups of habits)
// ========================================
...
export default function SystemsScreen() {
  ...
  const addSystem = useAtomicStore((s) => s.addSystem);
  const updateSystem = useAtomicStore((s) => s.updateSystem);
  const deleteSystem = useAtomicStore((s) => s.deleteSystem);
  const getSystemScore = useAtomicStore((s) => s.getSystemScore);
  ...
  const handleCreate = () => {
    ...
    const rate = parseInt(targetRate);
    if (isNaN(rate) || rate < 0 || rate > 100) {
      Alert.alert("Error", "Target completion rate must be between 0 and 100");
      return;
    }
  ...
  const handleEdit = (system: any) => {
    ...
    setIconName(system.iconName);
    setTargetRate((system.targetCompletionRate || 80).toString());
    setShowModal(true);
  };
  ...
  const handleDelete = (id: string) => {
    Alert.alert(
      "Delete System",
      "This will remove the system from all linked habits. Continue?",
      [
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F9FAFB", paddingTop: 60 }}>
      ...
      >
        <Text className="text-3xl font-bold text-gray-900">Systems</Text>
      ...
      <ScrollView className="flex-1 px-4 pt-6 pb-20">
          ...
          <View className="flex-row items-start space-x-3">
            ...
            <View className="flex-1">
              ...
              <Text className="text-xs text-blue-700">
                ...
                level of your systems.&rdquo; Focus on systems, not just goals.
              </Text>
            </View>
          </View>
        </View>
        ...
        {systems.length === 0 ? (
          ...
          <View className="space-y-3">
            {systems.map((system) => {
              const score = getSystemScore(system.id);
              const isOnTrack =
                score.completionRate >= (system.targetCompletionRate || 80);
              return (
                <View
                  key={system.id}
                ...
                >
                  <View className="flex-row items-center justify-between mb-3">
                    ...
                    <View className="flex-row items-center space-x-2">
                      ...
                      <Pressable
                        onPress={() => handleDelete(system.id)}
                        className="w-8 h-8 items-center justify-center"
                      >
                    ...
                    <View className="mt-3 pt-3 border-t border-gray-100">
                      ...
                      <View className="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <View
                          ...
                          style={{
                            width: `${Math.min(score.completionRate, 100)}%`,
          ...
          <ScrollView className="flex-1 px-4 pt-6 pb-20">
            ...
            <View className="mb-4">
              ...
              <TextInput
                ...
                placeholder="e.g., Health, Business, Personal Growth"
            ...
            <View className="mb-4">
              ...
              <Text className="text-xs text-gray-500 mt-1">
                Daily completion target for habits in this system
              </Text>
            </View>
